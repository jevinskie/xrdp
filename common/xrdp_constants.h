...
#define XRDP_TUMOD_ENCODER_HINTS_AVAILABLE 1

#define XRDP_ENCODER_HINT_QUALITY_LOWEST  0x0010
#define XRDP_ENCODER_HINT_QUALITY_LOW     0x0020
#define XRDP_ENCODER_HINT_QUALITY_MEDIUM  0x0040
#define XRDP_ENCODER_HINT_QUALITY_HIGH    0x0080
#define XRDP_ENCODER_HINT_QUALITY_HIGHEST 0x00f0
#define XRDP_ENCODER_HINT_QUALITY_AUTO    0x0100
